...
import static jgsp.memorymappedfiles.WorkSequentalMBPS.COPY_ID;
import static jgsp.memorymappedfiles.WorkSequentalMBPS.READ_ID;
...
Write file, use memory-mapped buffer.
*/
MappedStatusEntry mappedWrite( String path, int size, byte[] dataBlock )
    {
    /*
...
Overloaded method with auto-unmap buffer.
*/
MappedStatusEntry mappedRead( String path, int blockSize, boolean unmap )
    {
...
Read file, use memory-mapped buffer.
*/
MappedStatusEntry mappedRead( String path, int blockSize )
    {
    /*
    Initializing fields for returned object    
    */
