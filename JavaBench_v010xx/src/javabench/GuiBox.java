...
private final static int BY1 = 31;
...
private static final int NUM_OPTIONS = 4;    // Array Size, Threads Count
...
public GuiBox() {
    ...
    for ( int i=0; i<ARRAY_SIZE.length; i++ )
        {
        c1.addItem( Integer.toString( ARRAY_SIZE[i] ) + " doubles" ); 
        }
    ...
    sl.putConstraint ( SpringLayout.NORTH, pb,  BY2, SpringLayout.SOUTH, l4 );
    sl.putConstraint ( SpringLayout.WEST,  pb,  BX2, SpringLayout.EAST,  l5 );
    // run button
...
private class LstRun implements ActionListener
    ...
    @Override public void actionPerformed (ActionEvent e)
        ...
        if ( !(ActionRun.getRunning()) )
            ...
            Object[] disabledComponents = new Object[7];
            ...
            aRun = new ActionRun
                ( benchmarkTableModel , rangeModel , pb , 
                  ...
                  arraySize , threadsCount , repeatsCount , m ,
                  logValues , logTags );
            aRun.start();
            }
        }
