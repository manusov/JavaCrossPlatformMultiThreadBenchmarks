...
private final FunctionSingleThread functionSingleThread;  // Scenarios
private final FunctionMultiThread functionMultiThread;

public MathScenario
        ( int arraySize, int threadCount, int repeatCount, int patternSelect )
    {
    ...
    functionSingleThread = new FunctionSingleThread
        ( arraySize, INTERNAL_REPEATS, patternSelect );
    functionMultiThread = new FunctionMultiThread
